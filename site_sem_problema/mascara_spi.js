var loadingIndicator = document.getElementById('loading-mapa-interativo');
...
if (spi_quadrante === null || typeof spi_quadrante !== 'number' || isNaN(spi_quadrante)) {
    // console.warn(`Valor SPI inválido ou nulo encontrado na coluna ${coluna}, linha ${linha}. Pulando quadrante.`);
    continue; // Pula para a próxima iteração do loop, não desenha este quadrante
}
// FIM DA VERIFICAÇÃO
            let quadrante = {
                "type": "Feature",
